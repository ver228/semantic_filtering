...
def fasterrcnn_fpn_backbone(backbone_name, pretrained):
    print(backbone_name)
...
def retinanet_fpn_backbone(backbone_name, pretrained):
    print(backbone_name)
    ...
    return_layers = {'layer2': 'p3', 'layer3': 'p4', 'layer4': 'p5'}
    
    if backbone_name == 'resnet18' or backbone_name == 'resnet34':
        in_channels_stage3 = 128
    else:
        in_channels_stage3 = 512
        
    in_channels_list = [
        in_channels_stage3,
        in_channels_stage3 * 2,
        in_channels_stage3 * 4
    ]
    out_channels = 256
    
    
    return BackboneWithFPN(backbone, return_layers, in_channels_list, out_channels, last_level = 'p6p7')