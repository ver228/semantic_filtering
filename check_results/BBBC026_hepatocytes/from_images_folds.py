...
#    bn2check = [
#    'BBBC026-fold1/BBBC026-fold1_unet-filter_l1smooth_20190710_103719_adam_lr0.00032_wd0.0_batch32',
#    'BBBC026-fold2/BBBC026-fold2_unet-filter_l1smooth_20190710_103810_adam_lr0.00032_wd0.0_batch32',
#    'BBBC026-fold3/BBBC026-fold3_unet-filter_l1smooth_20190710_104252_adam_lr0.00032_wd0.0_batch32',
#    'BBBC026-fold4/BBBC026-fold4_unet-filter_l1smooth_20190710_104126_adam_lr0.00032_wd0.0_batch32',
#    'BBBC026-fold5/BBBC026-fold5_unet-filter_l1smooth_20190710_104126_adam_lr0.00032_wd0.0_batch32'
#            ]
    bn2check = [
    'BBBC026-fibroblast-fold1/BBBC026-fibroblast-fold1_unet-filter_l1smooth_20190711_114025_adam_lr0.00032_wd0.0_batch32',
    'BBBC026-fibroblast-fold3/BBBC026-fibroblast-fold3_unet-filter_l1smooth_20190711_114025_adam_lr0.00032_wd0.0_batch32',
    'BBBC026-fibroblast-fold5/BBBC026-fibroblast-fold5_unet-filter_l1smooth_20190711_114025_adam_lr0.00032_wd0.0_batch32',
    'BBBC026-fibroblast-fold4/BBBC026-fibroblast-fold4_unet-filter_l1smooth_20190711_114025_adam_lr0.00032_wd0.0_batch32',
    'BBBC026-fibroblast-fold2/BBBC026-fibroblast-fold2_unet-filter_l1smooth_20190711_151229_adam_lr0.00032_wd0.0_batch32',
    ]
    ...
    for bn in tqdm.tqdm(bn2check):
        ...
        #model_path = Path.home() / 'workspace/denoising/results/' / bn / 'checkpoint-24.pth.tar'
        ...
        root_dir = Path('/Users/avelinojaver/OneDrive - Nexus365/papers/miccai2019/data/hepatocytes/BBBC026/BBBC026_GT_images')
        fnames = ['A03_s1.png', 'A07_s4.png', 'C09_s2.png', 'E01_s8.png', 'M19_s6.png']
        fold_id = int(bn.rpartition('-fold')[-1].partition('_')[0])
        
        
        fname = root_dir / fnames[fold_id - 1]   
