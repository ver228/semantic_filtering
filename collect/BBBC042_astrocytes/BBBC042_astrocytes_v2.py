...
def _segment_crop(crop_ori, max_dist_norm = 0.42, min_length_norm = 0.3):
    ...
    if not(w/crop_m.shape[0] > min_length_norm or h/crop_m.shape[1] > min_length_norm):
        return
...
if __name__ == '__main__':
    ...
    save_root_dir = Path.home() / 'workspace/denoising/data/BBBC042_v2/'
    #%%
